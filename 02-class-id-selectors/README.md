...
### Self Check
- Do the odd numbered `p` elements share a class? Yes I did share
- Do the even numbered `div` elements have unique IDs?  Yes, each even numbered 'div' had unique ID
- Does the Number 3 element have multiple classes? Yes, Number 3 had multiple classes
