...
### Self Check
- Does each element have a unique class name? Yes it does.
- Did you use the grouping selector for styles that both elements share? Yes I did use the grouping selector for styles
- Did you make separate rules for the styles unique to each element? Yes, I did make separate rules
