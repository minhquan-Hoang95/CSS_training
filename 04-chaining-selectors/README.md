...
### Self Check
- Did you properly chain class selectors for each rule? Yes I did chain 
- Does the `proportioned` image retain its original square proportions? Yes It does
- Does the `distorted` image end up looking squished and, well, distorted? Yes, It is distorted
